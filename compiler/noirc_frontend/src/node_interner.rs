...
pub struct NodeInterner {
    ...
    trait_implementaions: HashMap<TraitImplKey, Shared<TraitImpl>>,
...
impl NodeInterner {
    ...
    pub fn get_trait_implementation(&self, key: &TraitImplKey) -> Option<Shared<TraitImpl>> {
        self.trait_implementaions.get(key).cloned()
    }

    pub fn add_trait_implementaion(&mut self, key: &TraitImplKey, trait_impl: Shared<TraitImpl>) {
        self.trait_implementaions.insert(key.clone(), trait_impl.clone());
