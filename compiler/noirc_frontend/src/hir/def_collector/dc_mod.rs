...
use crate::{
    ...
    NoirTypeAlias, ParsedModule, TraitImplItem, TraitItem, TypeImpl, UnresolvedTraitConstraint,
};
...
impl<'a> ModCollector<'a> {
    ...
    fn find_trait_or_emit_error(
        ...
        match module.find_trait_with_name(trait_name) {
            ...
            Err(ScopeResolveError::WrongType) => {
                let error =
    ...
    fn resolve_where_clause_trait_ids(
        &mut self,
    ...
    fn collect_functions(
        ...
        for mut function in functions {
            ...
            self.resolve_where_clause_trait_ids(&mut function.def.where_clause, errors);
